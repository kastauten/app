import {t}from'./chunk-OorIoqO5.js';import {i as ia,t as ta,Q as Qs,J as Js,e as ea,r as ra,O as Ot,c as ct,S as Se$1,p as ft,a5 as a,a6 as yr,a7 as Oc,a8 as ze,$ as $s,Z as Zs,a9 as Ec,q as Ls}from'./chunk-BZIaARf0.js';import {m}from'./chunk-BFk5fDeM.js';import'./main-CLGAHBX6.js';var Y=Ls.pie,D={sections:new Map,showData:false},u=D.sections,y=D.showData,fe=structuredClone(Y),he=Ot(()=>structuredClone(fe),"getConfig"),ue=Ot(()=>{u=new Map,y=D.showData,Zs();},"clear"),me=Ot(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);u.has(e)||(u.set(e,a),ct.debug(`added new section: ${e}, with value: ${a}`));},"addSection"),ve=Ot(()=>u,"getSections"),xe=Ot(e=>{y=e;},"setShowData"),Se=Ot(()=>y,"getShowData"),ee={getConfig:he,clear:ue,setDiagramTitle:ra,getDiagramTitle:ea,setAccTitle:Js,getAccTitle:Qs,setAccDescription:ta,getAccDescription:ia,addSection:me,getSections:ve,setShowData:xe,getShowData:Se},we=Ot((e,a)=>{t(e,a),a.setShowData(e.showData),e.sections.map(a.addSection);},"populateDb"),Ce={parse:Ot(async e=>{let a=await m("pie",e);ct.debug(a),we(a,ee);},"parse")},De=Ot(e=>`
  .pieCircle{
